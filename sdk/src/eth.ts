...
import { AbiItem, CallOptions, Network, Provider, ProviderNetwork } from './types';
...
function _ethJsonRpc(
  ...
  return new Promise<any>((resolve, reject) => {
    const provider = options._amplifyProvider || _createProvider(options);
...
/**
 * This helps the Amplify.js constructor discover which Ethereum network the
...
export async function getProviderNetwork(
  ...
  switch (true) {
    case String(networkId) === "80001": { // Deploy Matic network using goerli port
