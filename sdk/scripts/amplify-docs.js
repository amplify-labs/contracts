...
intro += '# Amplify.js\n\n';
intro += '## Introduction\n\n';
intro += '[Amplify Contracts](https://github.com/amplify-labs/contracts) is the Amplify Protocol and ';
intro += 'a JavaScript SDK for Ethereum . It wraps ';
...
intro += ' message in the Development channel of the Github.\n\n';
// intro += '</section>\n\n';
